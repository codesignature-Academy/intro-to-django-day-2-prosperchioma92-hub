...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=24194354&assignment_repo_type=AssignmentRepo)
...
## Homework Answers in my README.md
1.Difference between project and an app
A project is made up of several moving parts: tasks,authentication and an admin pannel. it is regarded as the entire website.
while an App:
An app can be regarded as a module respomsible for one specific feature inside the project, its examples are; a task app handles tasks while notification apps handles alerts.

2.what command creates a new Django App
python manage.py startapp (App name)

3.Why do we register an app inside `INSTALLED_APPS`?
Djando don't know tasks is an app, so we have to add it to 'INSTALLED_APPS" in settings.py

4. it helps you not to repeat the raw path over again. Instead, you call it by its name.